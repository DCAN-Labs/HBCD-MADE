...
if ~isempty(EEG.data)
    ...
    for i=1:Ncnd
        ydftavg = nanmean( Ydft(:,:,P.condition==i), 3);
    ...
    for i=1:Ncnd
        data_plv(:,:,i) = abs( nanmedian( Ydft(:,:,P.condition==i) ./ abs(Ydft(:,:,P.condition==i)) , 3 ) ); %LB this line changed! nanmedian instead of nanmean
    end
