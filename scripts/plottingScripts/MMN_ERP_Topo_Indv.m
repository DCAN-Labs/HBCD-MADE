...
% file_name = 'sub-PIUMD0059_ses-V03_task-MMN_acq-eeg_eeg_filtered_data_processed_data.set'
% save_path = 'Z:\Projects\hbcd\EEG\Official_Pilot\testing for CBrain\testing_data\PIUMD0059_392511_V03_bids\processed_data'
% save_name = 'sub-PIUMD0059_FACE_processed_data_MMN.mat'
% 
% save_path = 'Z:\Projects\hbcd\EEG\Official_Pilot\testing for CBrain\testing_data\PIUMD0059_392511_V03_bids\processed_data'
% save_name_jpg = 'sub-PIUMD0059_MMN_processed_data_MMN.jpg'
% 
% 
...
title(strcat('Standard',infoSafeTitle), 'FontSize', 20);
...
% 
% cd(save_path) 
% Plot_Name = '04_Topo_Upright2_MMN.jpg'
% merged_Plot_Name = [subject_ID, '_', Plot_Name];
% saveas(erp, merged_Plot_Name);  
