...
- FACE_UpInv: FACE task, face stimuli in block 1 (upright faces vs inverted faces)
- FACE_Inv: FACE task, inverted face stimuli in block 1 (upright faces vs inverted faces)
- FACE_Obj: FACE task, object stimuli in block 2 (upright faces vs objects)
- FACE_UpObj: FACE task, upright face stimuli in block 2 (upright faces vs objects)
- MMN_Standard: mismatch negativity, standard stimulus
- MMN_PreDev: mismatch negativity, standard stimulus preceding deviant stimulus
- MMN_Dev: mismatch negativity, deviant stimulus
