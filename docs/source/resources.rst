...
3. [Luck2021]_ Standardized measurement error (SME) provided in MADE output

4. [Mullen2012]_ CleanLine EEGLAB plugin used to estimate line noise in signal

5. [Nolan2010]_ "Faster" algorithm used in HBCD-MADE for artifact rejection
...
.. [Mullen2012] Mullen, T. (2012). CleanLine EEGLAB Plugin. San Diego, CA: Neuroimaging Informatics Toolsand Resources Clearinghouse (NITRC).
